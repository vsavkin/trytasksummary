...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/vm4kGdN1N1)
...
```sh
npx nx serve trytasksummary
```

To create a production bundle:

```sh
npx nx build trytasksummary
```

To see all available targets to run for a project, run:

```sh
npx nx show project trytasksummary
```
